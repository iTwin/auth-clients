 ...
 * @alpha
 */
export abstract class IntrospectionResponseCacheBase implements IntrospectionResponseCache {
...
/** @alpha */
export class MemoryIntrospectionResponseCache extends IntrospectionResponseCacheBase {
