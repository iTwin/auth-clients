 ...
 * @public
 */
export class ElectronAuthorizationRenderer implements AuthorizationClient {
  ...
  /** Constructor for ElectronAuthorizationRenderer. Sets up listeners for when the access token changes both on the frontend and the backend. */
  public constructor() {
